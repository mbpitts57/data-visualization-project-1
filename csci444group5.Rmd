...
```{r mollypitts2, message=FALSE, warning = FALSE}
...
```{r mollypitts3, message=FALSE, warning = FALSE}
...
```{r mollypitts4, message=FALSE, warning = FALSE}
...
```{r mollypitts5, message=FALSE, warning = FALSE}
...
```{r mollypitts6, message=FALSE, warning = FALSE}
...
```{r mollypitts7, messafe=FALSE, warning=FALSE}
...
```{r mollypitts8, message=FALSE, warning = FALSE}
...
```{r mollypitts9, message=FALSE, warning = FALSE}
...
2. What were the most common felonies committed in each borough of New York in 2000, 2010, and 2020?<br>
  ...
  In the year 2000 there were a variety of felonies being committed most often. As time goes on, the trends change. As seen across this report, as overall crime has decreased in New York, Grand Larceny has decreased the slowest, which has made it the most commonly committed felony in New York City today. I believe this has much to do with the fact that the definition of Grand Larceny is quite broad. I also imagine that as time goes on, criminals who need cash are more likely to risk stealing things of high value, which would qualify as Grand Larceny.
<br>
